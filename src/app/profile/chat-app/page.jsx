  ...
  return (
    <>
      <div className=" flex flex-col space-y-2">
        ...
        <div className="flex flex-wrap w-screen mt-8 flex-col h-screen">
          <div className="flex flex-col w-screen h-full">
            <div className="  rounded-md border-2 w-screen border-black snap-end dark:border-white flex flex-col justify-center items-start px-2 ">
              <div className="pb-4 w-screen overflow-hidden overflow-y-scroll">
                {dataInbox == null
                  ? ""
